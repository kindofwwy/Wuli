...
pl=[[0,100,0],[100,-100,100],[100,-100,-100],[-100,-100,-100],[-100,-100,100]]
c=[1,1,0]
tb=[triangle(pl[0],pl[1],pl[2],c),
    triangle(pl[0],pl[2],pl[3],c),
    triangle(pl[0],pl[3],pl[4],c),
    triangle(pl[0],pl[4],pl[1],c)]
